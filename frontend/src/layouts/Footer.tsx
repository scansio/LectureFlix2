...
function Footer() {
  ...
  return (
    <div class="nc-Footer relative py-16 lg:py-28 border-t border-neutral-200 dark:border-neutral-700">
          ...
          <div class="col-span-2 flex items-center md:col-span-3">
            ...
            >
              <a
                target="_blank"
                rel="noreferrer"
                href="https://web.facebook.com/profile.php?id=100086486423039"
                class="flex items-center text-2xl text-neutral-700 hover:text-black dark:text-neutral-300 dark:hover:text-white leading-none space-x-3 "
              >
                <div>
                  <svg
                    class="w-5 h-5"
              ...
              <a
                target="_blank"
                rel="noreferrer"
                href="https://x.com/elom_emmanuel7"
                class="flex items-center text-2xl text-neutral-700 hover:text-black dark:text-neutral-300 dark:hover:text-white leading-none space-x-3 "
              >
                <div>
                  <svg
              ...
              <a
                target="_blank"
                rel="noreferrer"
                href="https://www.linkedin.com/in/emmanuel-paul-elom-scansio"
                class="flex items-center text-2xl text-neutral-700 hover:text-black dark:text-neutral-300 dark:hover:text-white leading-none space-x-3 "
              >
                <div>
                  <svg
                ...
                <span class="hidden lg:block text-sm">Linkedin</span>
              </a>
              {/* <a
                href="#"
                class="flex items-center text-2xl text-neutral-700 hover:text-black dark:text-neutral-300 dark:hover:text-white leading-none space-x-3 "
              >
                ...
                <span class="hidden lg:block text-sm">Instagram</span>
              </a> */}
            </div>
          </div>
        </div>
